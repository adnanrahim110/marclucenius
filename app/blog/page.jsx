...
export default function Blog() {
  const posts = [
    ...
    },
    {
      ...
      excerpt:
        "Boundaries are not walls; they are the gates that protect your most valuable resources.",
      date: "August 30, 2023",
      category: "Leadership",
    },
  ];
            ...
            {posts.map((post) => (
              ...
              >
                <div className="flex flex-col h-full bg-primary-900/30 border border-primary-800/50 hover:border-accent-500/50 transition-all duration-300">
                  {/* Image Placeholder */}
                  <div className="w-full aspect-[16/9] bg-primary-800 relative overflow-hidden">
