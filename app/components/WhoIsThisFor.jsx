...
export default function WhoIsThisFor() {
  const items = [
    ...
    },
    {
      ...
      description:
        "who cares for children, family members and others and wonders if there is a place their own ambition",
    },
    {
        ...
        <div className="grid md:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <p className="text-primary-300 text-lg mb-8">
              ...
              those who want both an ambitious life and a deeply enjoyable life
              marked by rest.
            </p>
